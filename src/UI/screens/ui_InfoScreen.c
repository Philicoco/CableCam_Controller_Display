...
ui_L_Back_IS = lv_label_create(ui_BTNBackInfo);
lv_obj_set_width( ui_L_Back_IS, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_L_Back_IS, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_L_Back_IS, -2 );
lv_obj_set_y( ui_L_Back_IS, 2 );
lv_obj_set_align( ui_L_Back_IS, LV_ALIGN_CENTER );
lv_label_set_text(ui_L_Back_IS,"Back");
