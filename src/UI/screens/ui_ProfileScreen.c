...
lv_obj_set_x( ui_BTNBackProfile, -66 );
lv_obj_set_y( ui_BTNBackProfile, 128 );
...
ui_L_Back_PS = lv_label_create(ui_BTNBackProfile);
lv_obj_set_width( ui_L_Back_PS, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_L_Back_PS, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_L_Back_PS, -2 );
lv_obj_set_y( ui_L_Back_PS, 2 );
lv_obj_set_align( ui_L_Back_PS, LV_ALIGN_CENTER );
lv_label_set_text(ui_L_Back_PS,"Back");
...
ui_MoreBTN = lv_btn_create(ui_ProfileScreen);
lv_obj_set_width( ui_MoreBTN, 114);
lv_obj_set_height( ui_MoreBTN, 44);
lv_obj_set_x( ui_MoreBTN, 54 );
lv_obj_set_y( ui_MoreBTN, 129 );
lv_obj_set_align( ui_MoreBTN, LV_ALIGN_CENTER );
lv_obj_add_flag( ui_MoreBTN, LV_OBJ_FLAG_SCROLL_ON_FOCUS );   /// Flags
lv_obj_clear_flag( ui_MoreBTN, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
lv_obj_set_style_radius(ui_MoreBTN, 10, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_bg_color(ui_MoreBTN, lv_color_hex(0x1F60EA), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_opa(ui_MoreBTN, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_color(ui_MoreBTN, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_MoreBTN, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_align(ui_MoreBTN, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_MoreBTN, &lv_font_montserrat_16, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_L_More_PS = lv_label_create(ui_MoreBTN);
lv_obj_set_width( ui_L_More_PS, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_L_More_PS, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_L_More_PS, -2 );
lv_obj_set_y( ui_L_More_PS, 2 );
lv_obj_set_align( ui_L_More_PS, LV_ALIGN_CENTER );
lv_label_set_text(ui_L_More_PS,"More");
...
lv_obj_add_event_cb(ui_MoreBTN, ui_event_MoreBTN, LV_EVENT_ALL, NULL);
